...
function mm4_you_contact_form() {
	...
	<form name="contact-form" id="contact-form" method="POST" action="<?php echo $form_action; ?>" novalidate>
		...
		<label for="first-name">
			<input type="text" name="first-name" id="first-name" class="required" data-error-label="First Name" placeholder="* First Name">
		</label>
		<label for="last-name">
    ...
    <label for="primary-phone">
      <input type="tel" name="primary-phone" id="primary-phone" class="required" data-error-label="Primary Phone" placeholder="* Phone Number">
		...
		<label for="comments">
			<textarea name="comments" id="comments" rows="6" placeholder="Comments"></textarea>
		</label>
